...
public class WARCFormatProfiler extends Configured implements Tool {

	public int run( String[] args ) throws IOException {
		JobConf conf = new JobConf( getConf(), WARCFormatProfiler.class );
	...
	public static void main( String[] args ) throws Exception {
		...
		int ret = ToolRunner.run( new WARCFormatProfiler(), args );
